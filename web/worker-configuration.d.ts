/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 91dae9d5c48696948edb0d88a6deb409)
...
declare namespace Cloudflare {
	...
	interface Env {
		ASSETS: Fetcher;
		PUBLIC_FEATURE_SEARCH: string;
		PUBLIC_FEATURE_VIEW_COUNTER: string;
		PUBLIC_FEATURE_CONTACT: string;
		PUBLIC_FEATURE_OG: string;
		PUBLIC_FEATURE_MERMAID: string;
		PUBLIC_FEATURE_RSS: string;
		PUBLIC_FEATURE_BOOKS: string;
		PUBLIC_FEATURE_PROJECTS: string;
		PUBLIC_VIEW_COUNTER_URL: string;
